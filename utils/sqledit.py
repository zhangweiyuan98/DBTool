...
keywords = [
    ...
    'ADD', 'COLUMN', 'CHANGE', 'CALL', 'DELIMITER', 'SQL', 'SECURITY', 'INVOKER',
    'PROCEDURE', 'IF', 'EXISTS', 'DEFINER', 'WHILE', 'END', 'BIGINT', 'INT', 'VARCHAR',
    'DATETIME', 'DATE', 'CHAR', 'TEXT', 'BLOB', 'FLOAT', 'DOUBLE', 'DECIMAL', 'BOOLEAN',
    'TINYINT', 'SMALLINT', 'MEDIUMINT', 'ENUM', 'SET', 'YEAR', 'TIME', 'TIMESTAMP',
    'AUTO_INCREMENT', 'NOT NULL', 'NULL', 'DEFAULT', 'AFTER', 'BEFORE', 'CURRENT_TIMESTAMP',
    'CONSTRAINT', 'CHECK', 'INDEX', 'FULLTEXT', 'FOREIGN', 'REFERENCES', 'ON DELETE', 'ON UPDATE',
    'ASC', 'DESC', 'WITH', 'REPLACE', 'RENAME', 'PARTITION', 'TEMPORARY', 'SAVEPOINT', 'ROLLBACK TO',
    'TRANSACTION', 'LOCK', 'UNLOCK', 'WAIT', 'NOWAIT', 'START', 'END', 'DELIMITER', 'WITH', 'RECURSIVE',
    'ENUM', 'SET', 'BEGIN', 'DECLARATIVE', 'PERSIST', 'ISNULL', 'IS NOT NULL', 'INTERSECT', 'EXCEPT',
    'VALUES', 'LEAVE', 'ITERATE', 'CONTINUE', 'CONVERT', 'CAST', 'TRUNCATE', 'SUBSTRING', 'EXTRACT',
    'POSITION', 'COALESCE', 'IFNULL', 'NULLIF', 'ISNULL', 'IS NOT NULL', 'DATE_ADD', 'DATE_SUB', 'DATE_FORMAT',
    ...
    'LIMIT', 'FETCH', 'ROW_COUNT', 'FOUND_ROWS', 'SIGN', 'ROUND', 'CEIL', 'FLOOR', 'PI', 'RAND',
    'GREATEST', 'LEAST', 'CONCAT', 'CONCAT_WS', 'LEFT', 'RIGHT', 'TRIM', 'LENGTH', 'CHAR_LENGTH', 'SUBSTRING',
    'REPLACE', 'INSTR', 'REGEXP', 'REGEXP_REPLACE', 'RLIKE', 'MATCH', 'AGAINST', 'STRCMP', 'SOUNDEX',
    ...
    'UTC_TIMESTAMP', 'YEAR', 'MONTH', 'DAY', 'HOUR', 'MINUTE', 'SECOND', 'MICROSECOND', 'DATE_ADD', 'DATE_SUB',
    'TIMESTAMP', 'TIME_TO_SEC', 'SEC_TO_TIME', 'DATE_FORMAT', 'DATE_ADD', 'TIMESTAMPADD', 'TIMESTAMPDIFF', 'EXTRACT',
    'CONVERT_TZ', 'LAST_DAY', 'DATE_TRUNC', 'CURRENT_DATE', 'CURRENT_TIME', 'CURRENT_TIMESTAMP', 'NOW',
    'SYSDATE', 'CURDATE', 'CURTIME', 'SEC_TO_TIME', 'TIME_FORMAT', 'TIME_TO_SEC', 'UNIX_TIMESTAMP',
    'FROM_UNIXTIME', 'DATE_ADD', 'DATE_SUB', 'DATE_FORMAT', 'MONTHNAME', 'DAYNAME', 'DAYOFWEEK', 'DAYOFYEAR',
    'MONTH', 'YEAR', 'WEEK', 'WEEKOFYEAR', 'QUARTER', 'LAST_DAY', 'EXTRACT', 'DATEDIFF', 'STR_TO_DATE',
